...
## 4 使用 standard-changelog 生成 changelog
...
### 5.1 安装 `miniprogram-ci` 和 `cross-env`
```shell
pnpm install miniprogram-ci cross-env
```
### 5.2 添加 `scripts/ci.js`
```js
